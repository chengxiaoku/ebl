...
php;
    ...
    public function _webuploadercss(){
        $str=<<<php
<link rel="stylesheet" href="__PUBLIC__/Static/webuploader-0.1.5/xb-webuploader.css">
php;
        return $str;
    }
    ...
    public function _webuploaderjs(){
        $str=<<<php
<script>
    var BASE_URL = '__PUBLIC__/Static/webuploader-0.1.5';
</script>
<script src= "__PUBLIC__/Static/webuploader-0.1.5/webuploader.min.js"></script>
php;
        return $str;
    }
